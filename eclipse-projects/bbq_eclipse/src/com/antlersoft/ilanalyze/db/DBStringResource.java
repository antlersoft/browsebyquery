...
public class DBStringResource implements Persistent {
	...
	final static String STRING_RESOURCE_VALUE_INDEX="STRING_RESOURCE_VALUE_INDEX";
	final static String STRING_RESOURCE_NAME_INDEX="STRING_RESOURCE_NAME_INDEX";

	ObjectRef<DBString> _name;
	ObjectRef<DBString> _value;
	ObjectRef<DBBundle> _bundle;
	...
	DBStringResource( DBBundle bundle, DBString name, DBString value){
		_bundle=new ObjectRef<DBBundle>( bundle);
	...
	static class ValueKeyGenerator implements KeyGenerator
	{

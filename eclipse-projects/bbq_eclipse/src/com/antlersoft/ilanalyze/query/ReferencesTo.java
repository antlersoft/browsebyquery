...
/**
 * Changes a set of DBField or DBString to a set of DBFieldReference or DBStringReference, respectively
...
class ReferencesTo extends Transform
{
	...
	public Enumeration transformObject( DataSource source, Object base)
	{
        ...
        {
            return ((DBString)base).getReferencesTo( (ILDB)source);
        }
        else
		    return ((DBField)base).getReferencesTo( (ILDB)source);
	}
